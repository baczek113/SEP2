...
//        // Dummy data
//        todoTasks.addAll(
//                new Task("Write report", "dev1", "High", "To Do"),
//                new Task("Design login page", "admin", "Medium", "To Do")
//        );
//        doingTasks.add(new Task("Implement feature X", "dev2", "High", "Doing"));
//        doneTasks.add(new Task("Fix bug #45", "dev1", "Low", "Done"));
//        checkedTasks.add(new Task("Code review", "PO", "Medium", "Done and Checked"));
//    }
//
...
//    @FXML
//    private void goBack() {
//        viewHandler.openView("ManageSprints"); // Or previous view
//    }
//
//    @FXML
